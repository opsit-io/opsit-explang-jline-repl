...
```
mvn org.apache.maven.plugins:maven-dependency-plugin:2.8:get -Dartifact=io.opsit:opsit-explang-jline-repl:0.0.8:jar:runnable   -Dtransitive=false -Ddest=opsit-explang-jline-repl-0.0.8-runnable.jar
```
...
```
$ java -jar opsit-explang-jline-repl-0.0.8-runnable.jar
